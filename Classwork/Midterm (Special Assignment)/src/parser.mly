...
expr:
    ...
    | INSERT; LPAREN; e1 = expr; COMMA; e2 = expr; COMMA; e3 = expr; RPAREN { Insert(e1,e2,e3) }
    | LOOKUP; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Lookup(e1,e2) }
    | REMOVE; LPAREN; e1 = expr; COMMA; e2 = expr; RPAREN { Remove(e1,e2) }
